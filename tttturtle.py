...
def setup_tictactoe(turtle):
        ...
        turtle.left(90)
        turtle.forward(180)
        turtle.write("Misère", font=("Arial", 36, "normal"))
...
ttt=turtle.Turtle()
ttt.ht()  #makes turtle invisible
ttt.speed(0)  #so it goes faster
ttt.color("white")  #changes the color
setup_tictactoe(ttt)  #calling the fuction to setup the board

#adjusting my turtle, to do other tasks
ttt.pensize(3)
ttt.color("red")  #changing colors
ttt.penup()
ttt.home()  #putting turtle back to the start

#telling the user how the game is played and giving them an introduction
print("Bienvenue! Joueur 1 est O, joueur 2 est X")
print("Pour jouer, choisissez un numéro de 1 à 9 et appuyez sur Enter.")
...
while counter!=1: #the counter will be 1, only if someone wins or if its a draw.
        ...
        while counter3==0:  #it will keep looping until the number is good and usable
                if counter2%2 == 0:  #if its even (no remainder when divided by two.). It keeps track of who's turn it is.
                        if counter2==2: #if its their first turn, it gives the user more instruction than the other turns
                                user_number=int(input(("Joueur 2, choisissez votre boîte (et appuyez Enter) : "))) #turning it into a number
                        else:
                                user_number=int(input(("Joueur 2, à votre tour : ")))
                        if board[user_number-1]=="x" or board[user_number-1]=="o":  #checking if the number they gave already is an x or an o. 
                                print("Cette boîte est déjà occupée; essayez à nouveau.")
                        else:  
                        ...
                        if counter2==1:  #if its their first turn, it gives the user more instruction than the other turns
                                user_number=int(input(("Joueur 1, choisissez votre boîte (et appuyez Enter) : ")))  #turning it into a number
                        else:
                                user_number=int(input(("Joueur 1, à votre tour : ")))
                        if board[user_number-1]=="x" or board[user_number-1]=="o" : #checking if the number they gave already is an x or an o. 
                                print("Cette boîte est déjà occupée; essayez à nouveau.")
                        else:
                                counter3=counter3+1#adding one to counter so it knows that the number that is given is usable.
        ...
        if counter2%2 == 0: #if counter is even (no remainder when divided by two.)... If its player two's turn.
                if number==1:  #if number is 1 it goes through this loop
                                ...
                                if board[1]=="x":
                                        if board[2]=="x":
                                                print("Félicitations au joueur 2, vous gagnez!")
                                                counter=counter+1
                                elif board[3]=="x":
                                        if board[6]=="x":
                                                print("Félicitations au joueur 2, vous gagnez!")
                        ...
                        if number==1: #if number is 1 it goes through this loop
                                ...
                                if board[1]=="o":
                                        if board[2]=="o":
                                                print("Félicitations au joueur 1, vous gagnez!")
                                                counter=counter+1
                                elif board[3]=="o":
                                        if board[6]=="o":
                                                print("Félicitations au joueur 1, vous gagnez!")
...
print("Merci pour jouer! Appuyez sur l'écran du jeu pour sortir.")
screen.exitonclick()
